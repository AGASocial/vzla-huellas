...
export default function Home() {
  return (
    <main className="min-h-screen bg-neutral-950 text-white w-full max-w-3xl mx-auto px-4 sm:px-8 py-6 sm:py-10 flex flex-col gap-8">
      ...
      <nav className="flex flex-col gap-4">
        <Link
          ...
          className="rounded-xl bg-teal-900/60 hover:bg-teal-900 transition-colors p-5 flex flex-col gap-1"
        >
        ...
        <Link
          href="/candidatos"
          className="rounded-xl border border-neutral-700 hover:border-neutral-500 transition-colors p-5 flex flex-col gap-1"
        >
